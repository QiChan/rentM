...
var ErrMsgCodeRegisterError = xerr.NewErrMsg("msg code mismatch")
...
func (l *RegisterLogic) Register(in *pb.RegisterReq) (*pb.RegisterResp, error) {
	...
	if user != nil {
		return nil, errors.Wrapf(ErrUserAlreadyRegisterError, "Register user exists:%s,err:%v", in.Mobile, err)
	}

	//msgCode verified by thirdParty lib in the future
	if in.MsgCode != "8210" {
		return nil, errors.Wrapf(ErrMsgCodeRegisterError, "Register msgCode not pass verified:%s,err:%v", in.MsgCode, ErrMsgCodeRegisterError)
	}
